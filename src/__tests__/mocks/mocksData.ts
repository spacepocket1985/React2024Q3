...
export const mockTransformCharactersData: TransformCharacterType[] = [
  {
    id: '17333532-5d00-4b71-b8b1-8e762a12c793',
...
export const responseData2: ApiResponseType = {
  data: mockTransformCharactersData,
  meta: {
    pagination: {
      current: 2,
      first: 1,
...
export const mockInitialState = {
  potterDbApi: {
    queries: {
      'getAllCharacters({"filter":"","pageNum":"1"})': {
        status: 'fulfilled',
        endpointName: 'getAllCharacters',
        requestId: 'hyxXuIh3GRuJK3nq87Tfm',
        originalArgs: {
          pageNum: '1',
          filter: '',
        },
        startedTimeStamp: 1721212133208,
        data: {
          сharacters: [
            {
              id: '17333532-5d00-4b71-b8b1-8e762a12c793',
        ...
        fulfilledTimeStamp: 1721212136796,
      },
    },
    mutations: {},
    provided: {},
...
export const mockInitialState2 = {
  potterDbApi: {
    queries: {
      'getAllCharacters({"filter":"","pageNum":"1"})': {
        status: 'fulfilled',
